...
VEXO may provide access to an AI-powered assistant ("VEXO AI"). VEXO AI is designed to provide information and assistance based on user-provided prompts.

AI-generated responses may be incorrect, incomplete, outdated, misleading, biased, or unsuitable for a particular situation. VEXO does not guarantee the accuracy, reliability, completeness, or usefulness of any response generated by VEXO AI.

You acknowledge that AI-generated content may contain errors and should not be treated as verified facts.

VEXO AI is not a substitute for qualified professional advice, including medical, legal, financial, educational, or other specialized advice. You should consult a qualified professional and independently verify important information before making decisions based on AI-generated responses.

You are solely responsible for how you use information, suggestions, or content generated by VEXO AI. VEXO is not responsible for decisions, actions, or outcomes resulting from your reliance on AI-generated content, to the maximum extent permitted by applicable law.

VEXO AI may process your prompts, messages, conversation content, and other information necessary to provide and operate the AI functionality. Your use of VEXO AI is subject to VEXO's Privacy Policy. Information may be processed by third-party AI service providers used to operate the service, as disclosed in the Privacy Policy.

You should avoid sharing sensitive personal information, passwords, financial details, or other confidential information in your conversations.

VEXO may impose usage limits, message limits, rate limits, or other restrictions on VEXO AI. VEXO AI may be temporarily unavailable due to maintenance, technical issues, service interruptions, or changes to third-party AI providers.

VEXO does not guarantee uninterrupted availability, response speed, performance, or continued access to any AI model or provider.

VEXO may use third-party AI models, APIs, or service providers to power certain AI functionality. The availability, performance, and behavior of VEXO AI may depend on these third-party services.

You agree not to use VEXO AI to engage in unlawful activities, generate malicious software or harmful content, bypass security measures or usage restrictions, abuse or disrupt the service, commit fraud, impersonate others, or violate the rights of other individuals or entities.

VEXO reserves the right to restrict, suspend, or terminate access to VEXO AI if it reasonably believes that a user has violated these Terms or poses a risk to the service, subject to applicable law.

VEXO AI may generate text, code, recommendations, or other content in response to your prompts. You are responsible for reviewing AI-generated content before using, publishing, distributing, or relying on it.

VEXO does not guarantee that AI-generated content is original, free from errors, or suitable for commercial or personal use. You are responsible for ensuring that your use of AI-generated content complies with applicable laws and third-party rights.

VEXO does not guarantee that VEXO AI will meet your specific requirements, produce a particular result, or operate without errors. AI functionality may be modified, updated, restricted, discontinued, or replaced at any time, subject to applicable law.

To the maximum extent permitted by applicable law, VEXO and its owners, operators, affiliates, employees, and service providers shall not be liable for losses, damages, or claims arising from your use of, or reliance on, VEXO AI or AI-generated content. This limitation does not exclude or limit liability that cannot lawfully be excluded or limited under applicable law.

By using VEXO AI, you acknowledge that AI-generated responses are not guaranteed to be accurate or reliable, that you are responsible for independently verifying important information, and that AI services may have limitations, restrictions, and interruptions. You use VEXO AI at your own discretion and risk, subject to your rights under applicable law.
